...
class Constantes {
  ...
  static final List<ForfaitAppel> forfaitsAppel = [
    ForfaitAppel('1000f v TR', '25 SMS', 'Validité 1 j', '200 XOF', '*909*4*1*1*1#'),
    ForfaitAppel('1800f v TR', '75 SMS', 'Validité 2 j', '400 XOF', '*909*4*1*3*1#'),
    ForfaitAppel('2500f v TR', '25 SMS', 'Validité 3 j', '500 XOF', '*909*4*1*2*1#'),
    ForfaitAppel('3100f v TR', '75 SMS', 'Validité 3 j', '600 XOF', '*909*4*1*4*1#'),
    ForfaitAppel('5500f v TR', '50 SMS', 'Validité 7 j', '1.000 XOF', '*909*4*2*1*1#'),
    ForfaitAppel('12000f v TR', '100 SMS', 'Validité 7 j', '2.000 XOF', '*909*4*2*2*1#'),
    ForfaitAppel('17100f v TR', '100 SMS', 'Validité 7 j', '3.000 XOF', '*909*4*2*3*1#'),
    ForfaitAppel('60000f v TR', '200 SMS', 'Validité 30 j', '9.000 XOF', '*909*4*3*1*1#'),
  ];
